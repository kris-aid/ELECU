...
def test_extract_eleccion(year=2023,tipo="generales"):
    ...
    df_resultados_filtered = extract_eleccion(df_resultados, dignidad_codigo="4", territorio_codigo="EC0901",agrupar_por_territorio="CANTON", sexo="AMBOS", vuelta="1")
    df_votacion_filtered = extract_votacion(df_votacion, dignidad_codigo="4", territorio_codigo="EC0901",agrupar_por_territorio="CANTON", sexo="AMBOS", vuelta="1")
